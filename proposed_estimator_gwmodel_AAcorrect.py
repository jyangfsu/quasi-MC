...
def fast_MC(x, pvalues_A, pvalues_B, print_to_console=False):
    ...
    # Second-item
    E_A2_G1M1_IT2 = np.mean(Y_A_R1G1M1 * Y_A_R2G1M1) * PMA[0] * PMA[1] * (PMB[0] * PMC[0]) + \
                    np.mean(Y_A_R2G1M1 * Y_A_R1G1M1) * PMA[1] * PMA[0] * (PMB[0] * PMC[0])
    
    E_A2_G1M2_IT2 = np.mean(Y_A_R1G1M2 * Y_A_R2G1M2) * PMA[0] * PMA[1] * (PMB[0] * PMC[1]) + \
                    np.mean(Y_A_R2G1M2 * Y_A_R1G1M2) * PMA[1] * PMA[0] * (PMB[0] * PMC[1]) 
                 
    E_A2_G2M1_IT2 = np.mean(Y_A_R1G2M1 * Y_A_R2G2M1) * PMA[0] * PMA[1] * (PMB[1] * PMC[0]) + \
                    np.mean(Y_A_R2G2M1 * Y_A_R1G2M1) * PMA[1] * PMA[0] * (PMB[1] * PMC[0]) 
    
    E_A2_G2M2_IT2 = np.mean(Y_A_R1G2M2 * Y_A_R2G2M2) * PMA[0] * PMA[1] * (PMB[1] * PMC[1]) + \
                    np.mean(Y_A_R2G2M2 * Y_A_R1G2M2) * PMA[1] * PMA[0] * (PMB[1] * PMC[1])
    ...
    # Second-item
    E_B2_R1M1_IT2 = np.mean(Y_A_R1G1M1 * Y_A_R1G2M1) * PMB[0] * PMB[1] * (PMA[0] * PMC[0]) + \
                    np.mean(Y_A_R1G2M1 * Y_A_R1G1M1) * PMB[1] * PMB[0] * (PMA[0] * PMC[0]) 
    
    E_B2_R1M2_IT2 = np.mean(Y_A_R1G1M2 * Y_A_R1G2M2) * PMB[0] * PMB[1] * (PMA[0] * PMC[1]) + \
                    np.mean(Y_A_R1G2M2 * Y_A_R1G1M2) * PMB[1] * PMB[0] * (PMA[0] * PMC[1])
                 
    E_B2_R2M1_IT2 = np.mean(Y_A_R2G1M1 * Y_A_R2G2M1) * PMB[0] * PMB[1] * (PMA[1] * PMC[0]) + \
                    np.mean(Y_A_R2G2M1 * Y_A_R2G1M1) * PMB[1] * PMB[0] * (PMA[1] * PMC[0]) 
    
    E_B2_R2M2_IT2 = np.mean(Y_A_R2G1M2 * Y_A_R2G2M2) * PMB[0] * PMB[1] * (PMA[1] * PMC[1]) + \
                    np.mean(Y_A_R2G2M2 * Y_A_R2G1M2) * PMB[1] * PMB[0] * (PMA[1] * PMC[1])
    ...
    E_C2_R1G1_IT2 = np.mean(Y_A_R1G1M1 * Y_A_R1G1M2) * PMC[0] * PMB[1] * (PMA[0] * PMB[0]) + \
                    np.mean(Y_A_R1G1M2 * Y_A_R1G1M1) * PMC[1] * PMB[0] * (PMA[0] * PMB[0])
    
    E_C2_R1G2_IT2 = np.mean(Y_A_R1G2M1 * Y_A_R1G2M2) * PMC[0] * PMB[1] * (PMA[0] * PMB[1]) + \
                    np.mean(Y_A_R1G2M2 * Y_A_R1G2M1) * PMC[1] * PMB[0] * (PMA[0] * PMB[1])
                 
    E_C2_R2G1_IT2 = np.mean(Y_A_R2G1M1 * Y_A_R2G1M2) * PMC[0] * PMB[1] * (PMA[1] * PMB[0]) + \
                    np.mean(Y_A_R2G1M2 * Y_A_R2G1M1) * PMC[1] * PMB[0] * (PMA[1] * PMB[0]) 
    
    E_C2_R2G2_IT2 = np.mean(Y_A_R2G2M1 * Y_A_R2G2M2) * PMC[0] * PMB[1] * (PMA[1] * PMB[1]) + \
                    np.mean(Y_A_R2G2M2 * Y_A_R2G2M1) * PMC[1] * PMB[0] * (PMA[1] * PMB[1])
